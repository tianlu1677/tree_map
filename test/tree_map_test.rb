...
class TreeMapTest < Minitest::Test
  def test_tree_map
    ...
    assert_nil(m.lower_key(0))
    assert_nil(m.floor_key(0))
    assert_equal(1, m.ceiling_key(0))
    assert_equal(1, m.higher_key(0))

    assert_nil(m.lower_key(1))
    ...
    assert_nil(m.higher_key(100))

    assert_equal(100, m.lower_key(500))
    assert_equal(100, m.floor_key(500))
    assert_nil(m.ceiling_key(500))
    assert_nil(m.higher_key(500))
  end
